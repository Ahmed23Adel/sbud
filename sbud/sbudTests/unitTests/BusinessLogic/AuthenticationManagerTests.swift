...
class AuthenticationManagerTests: XCTestCase {
    ...
    override func setUp(){
        ...
        UserDefaults.standard.removeObject(forKey: AppStorageConstants.SIGN_IN_METHOD)
    }
    ...
    func testInit_WhenSignInMethodUnknown_SetsUserLoggedOut() {
        // Arrange
        UserDefaults.standard.set(AuthenticationConstants.METHOD_UNKNOWN, forKey: AppStorageConstants.SIGN_IN_METHOD)
    ...
    func testInit_WhenSignInMethodGoogle_InitializesGoogleManager() {
        // Arrange
        UserDefaults.standard.set(AuthenticationConstants.METHOD_GOOGLE, forKey: AppStorageConstants.SIGN_IN_METHOD)
        
        // Act
        sut = AuthenticationManager()
        
        // Assert
        XCTAssertEqual(sut.signInMethod, AuthenticationConstants.METHOD_GOOGLE)
    }
    
    func testInit_WhenSignInMethodEmailAndPassword_InitializesEmailPasswordManager() {
        // Arrange
        UserDefaults.standard.set(AuthenticationConstants.METHOD_EmailAndPassword, forKey: AppStorageConstants.SIGN_IN_METHOD)
        
        // Act
        sut = AuthenticationManager()
        
        // Assert
        XCTAssertEqual(sut.signInMethod, AuthenticationConstants.METHOD_EmailAndPassword)
    }
    ...
    func testSignOut_ClearsSignInMethodAndManager() async throws {
        ...
        // Assert
        XCTAssertEqual(sut.signInMethod, AuthenticationConstants.METHOD_UNKNOWN)
    }
}
