...
final class JoinStateTests: XCTestCase {
    ...
    func test_isDisabled_left_isFalse()      { XCTAssertFalse(JoinState.withdrawn.isDisabled) }
    ...
    func test_labelText_left_isJoinActivity()      { XCTAssertEqual(JoinState.withdrawn.labelText, "Join Activity") }
    ...
    func test_iconName_left_isDoor()      { XCTAssertEqual(JoinState.withdrawn.iconName, "door.left.hand.open") }
    ...
    func test_canWithdraw_otherStates_areFalse() {
        let nonWithdrawStates: [JoinState] = [.idle, .confirmed, .rejected, .withdrawn, .full]
    ...
    func test_differentCases_notEqual() {
        ...
        XCTAssertNotEqual(JoinState.confirmed, JoinState.withdrawn)
    }
}
