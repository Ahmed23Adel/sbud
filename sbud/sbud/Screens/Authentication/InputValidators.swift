...
class InputValidators{
    ...
    func validateInputs(email: String, password: String, emailAlertFunction: @escaping () -> Void, passwordAlertFunction: @escaping () -> Void) -> Bool{
        return isEmailValid(email, emailAlertFunction: emailAlertFunction) && isPasswordValid(password, passwordAlertFunction: passwordAlertFunction)
    }
