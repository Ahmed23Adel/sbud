...
class SignUpViewModel: ObservableObject {
    ...
    func signUpWithEmail() async throws {
        ...
        isSigningUp = true
        do {
            //let username = UsernameGenerator.generate()//we need to save this on firebase 
...
//generate the username (because when we log in with phone the email is optional so we need a non option
//var -->username like tiktok or instagram autogenerated and then we can change)
